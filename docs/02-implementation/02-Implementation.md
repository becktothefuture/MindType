...
- [ ] (P1) [LM‑LAB‑SPEC] Author JSONL stream SPEC and examples  
       **AC:** SPEC doc `docs/.././06-guides/reference/lm-stream.md` with event types (`meta`, `rules`, `stage`, `diff`, `commit`, `log`, `done`), transcript examples, invariants; `doc:check` passes.
      **Owner:** @alex  
...
- [ ] (P2) [FT-322] Add Playwright e2e for BDD scenarios  
       **AC:** Tests for caret safety and streamed diffusion mapped to `docs/12-qa/qa/acceptance/*` with visible active region and highlight assertions  
       **Owner:** @alex  
       **DependsOn:** FT-321  
       **Source:** BDD suite
...
- [ ] `docs/.././06-guides/reference/active-region-design.md` — Visual design, tokens, reduced‑motion variants
- [ ] `docs/.././06-guides/how-to/mac-ux.md` — macOS UX flows (onboarding, prefs, overlays)
...
- id: MODEL-001
  ...
  output: core/lm/policy.ts, docs/.././06-guides/reference/lm.md (prompt)
...
- id: MODEL-002
  ...
  output: datasets/fuzzy_text_en.jsonl, docs/.././06-guides/how-to/fuzzy-text-dataset.md
...
- id: DIAG-001
  ...
  output: Console captures in docs/.././06-guides/reference/workbench.md (appendix)
...
- id: FINAL-001
  ...
  output: web-demo (verified), docs/.././06-guides/reference/workbench.md (demo notes)
```

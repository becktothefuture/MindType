...
> Mirror note: This is an export mirror for NotebookLM. The canonical Master is `docs/00-index/00-README.md` in the repository.
...
- [`docs/01-prd/01-PRD.md`](PRD.md) - Product requirements and success criteria
- [`docs/02-implementation/02-Implementation.md`](implementation.md) - Current task tracking and quality gates
...
- [`docs/06-guides/06-03-reference/`](guide/reference/) - API contracts and implementation guides
